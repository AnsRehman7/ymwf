  ...
  return (
    <section id="top" className="relative pt-40 pb-28 md:pt-52 md:pb-36 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 grid md:grid-cols-[1.15fr_0.85fr] gap-14 items-end">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-[var(--forest)]/25 bg-[var(--forest)]/5 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.16em] text-[var(--forest)] opacity-0 animate-[fadeUp_0.8s_0.1s_cubic-bezier(0.16,1,0.3,1)_forwards]">
            Non-profit organisation · Lahore, Punjab
          </div>
          ...
          <p className="mt-8 max-w-lg text-[1.05rem] leading-relaxed text-[var(--ink)]/75 opacity-0 animate-[fadeUp_0.9s_0.36s_cubic-bezier(0.16,1,0.3,1)_forwards]">
            {foundation.mission} We empower youth through merit-based support, skill
            development, and community outreach across Lahore and beyond.
          </p>
        ...
        <div className="opacity-0 animate-[fadeUp_1s_0.45s_cubic-bezier(0.16,1,0.3,1)_forwards]">
          <div className="relative rounded-[1.75rem] border border-[var(--line)] bg-[var(--cream-dim)] p-7 shadow-[0_30px_60px_-30px_rgba(33,29,22,0.35)]">
            <p
              lang="ur"
              dir="rtl"
              className="font-display text-[1.35rem] leading-[2] text-[var(--forest-deep)]"
            >
              {founder.quoteUrdu}
            </p>
            <p className="mt-4 text-sm leading-relaxed text-[var(--ink)]/60 italic">
              {founder.quoteEnglish}
            </p>
            <div className="mt-6 flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-[var(--ink)]/60">Founder</div>
              </div>
            </div>
